<template>
  <SuperAdminLayout page-title="Edit Plan">
    <div class="max-w-2xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-gray-600 dark:text-gray-400 mt-1">Update this subscription plan.</p>
        </div>
      </div>
        ...
        <div class="card mb-6">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input v-model="form.price_monthly" type="number" step="0.01" min="0" class="input-field" />
            ...
            <div>
              ...
              <input v-model="form.price_yearly" type="number" step="0.01" min="0" class="input-field" />
        ...
        <div class="card mb-6">
          ...
          <div class="space-y-2">
            <div v-for="(feature, index) in form.features" :key="index" class="flex items-center gap-2">
              <input v-model="form.features[index]" type="text" class="input-field" />
...
const submit = () => {
  ...
  })).put(route('superadmin.plans.update', props.plan.id));
};
</script>
