      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-2">
          <button
            ...
            :class="{
              'border-brand-500 bg-brand-50 dark:bg-brand-900/20 text-brand-600 dark:text-brand-400': selectedMethod === methodOption.id,
        ...
        <div class="text-center">
          ...
          <button
            ...
            @click="resendOTP"
            :disabled="isResending"
            class="text-sm font-medium text-brand-600 dark:text-brand-400 hover:text-brand-700 dark:hover:text-brand-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div class="text-center">
          <p class="text-sm text-slate-600 dark:text-slate-400">
            <a href="/login" class="font-medium text-brand-600 dark:text-brand-400 hover:underline">
              Back to login
            </a>
          </p>
        </div>
