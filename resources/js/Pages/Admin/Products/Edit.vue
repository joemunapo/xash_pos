  ...
  <AdminLayout page-title="Edit Product">
    ...
    <div class="mx-auto">
      ...
      <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-400 mt-1">Update product details and inventory settings</p>
      </div>
      ...
      <form @submit.prevent="submit" class="space-y-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              <div>
                ...
                <input v-model="form.sku" type="text" :class="['input-field', form.errors.sku && 'border-red-500 focus:border-red-500 focus:ring-red-500']" placeholder="Optional" />
          ...
          <div class="card p-6">
            ...
            <div class="flex items-start gap-4">
              <div class="w-28 h-28 bg-gray-100 dark:bg-slate-800 rounded-lg flex items-center justify-center overflow-hidden border-2 border-dashed border-gray-300 dark:border-slate-600 shrink-0">
                ...
                <img v-else-if="product.image && product.image.length > 1" :src="`/storage/${product.image}`" alt="Product" class="w-full h-full object-cover" />
              ...
              <div class="flex-1">
                <label class="btn-secondary cursor-pointer inline-flex items-center text-sm">
                  ...
                  {{ form.image || product.image ? 'Change' : 'Upload' }}
        ...
        <div class="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-slate-700">
          ...
          <button type="submit" :disabled="form.processing" class="btn-primary">
            ...
            <span v-else><i class="fas fa-check mr-2"></i>Save Changes</span>
          </button>
        </div>
      </form>
    </div>
...
const props = defineProps({ product: Object, categories: Array, units: Array, parentCategories: Array });
...
const form = useForm({
  ...
  plu_code: props.product.plu_code || '',
  ...
  reorder_level: props.product.reorder_level || 10,
  reorder_quantity: props.product.reorder_quantity || 50,
  is_active: props.product.is_active,
  packaging: props.product.product_units?.map(unit => ({
    name: unit.name,
...
const submit = () => {
  // Use POST with method spoofing for file uploads (multipart/form-data limitation with PUT)
