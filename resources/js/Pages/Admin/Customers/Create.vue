<template>
  <AdminLayout page-title="Create Customer">
    <div class="max-w-lg">
      <div class="mb-6">
      ...
      <form @submit.prevent="submit" class="card p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input v-model="form.phone" type="text" class="input-field" placeholder="+263771234567" />
          </div>
          <div>
        ...
        <div class="flex justify-end gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
          ...
          <button type="submit" :disabled="form.processing" class="btn-primary">Create Customer</button>
        </div>
      </form>
    </div>
  </AdminLayout>
...
const form = useForm({
  ...
  city: '', address: '', date_of_birth: '', gender: '',
});

const submit = () => form.post(route('admin.customers.store'));
</script>
